...
# WIP120: hide Decrypt Data button when no lockscreen credential (check spblob file)
PATCH_DECRYPT_VISIBILITY="$DEVICE_PATH/patches/0010-decrypt-button-visibility.patch"
...
if [ -d "$TWRP_ROOT" ]; then
    ...
    apply_patch "$PATCH_DECRYPT_VISIBILITY" "$TWRP_ROOT/gui/theme/common/portrait.xml" "spblob:gui/theme/common/portrait.xml"
